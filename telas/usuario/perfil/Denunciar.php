<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($_POST["apelido_denunciado"])){
            $apelido_denunciado = $_POST["apelido_denunciado"];
        }
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            $param_id_denunciado = $id_denunciado;
...
<body class="bg-light">
    ...
    <div class="container-fluid text-center mt-3">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <input type="hidden" value="<?php $_GET["id"] ?>" name="id_denunciado">
            <input type="hidden" value="<?php $_GET["apelido"] ?>" name="apelido_denunciado">
