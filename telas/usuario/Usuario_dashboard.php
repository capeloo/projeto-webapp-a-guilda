<?php 
    ...
    if($_SESSION["admin"] == 0){
      ...
      echo "<a class='navbar-brand' id='logo' href='Usuario_dashboard.php'>Taverna</a>";
      ...
      echo '<button class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown">Perfil</button>';
      echo 'Perfil';
      echo '</button>';
