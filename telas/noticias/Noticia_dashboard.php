<?php 
  ...
  echo '<header class="sticky-top" id="h">';
            ...
            echo '</header>';
            echo '<main>';
  echo '<div class="mt-3" style="width: 1080px; padding: 0px; margin: auto;">';
  echo '<div style="display: flex;">';
  echo '<img src="../../assets/images/moldura-esquerda.png" style="width: 160px; height:160px;">';
  echo '<img src="' .$row["foto"]. '" style="width: 800px; height:400px;" class="mt-3">';
  echo '<img src="../../assets/images/moldura-direita.png" style="width: 150px; height:150px;">';
  echo '</div>';
