<?php 
    ...
    echo '<input type="submit" value="Próxima Página" id="inputMesa" name="botao">';
    echo '</form>';
    echo '<form action="" method="post">';
    echo '<input type="submit" value="Voltar" id="inputMesa" name="botaoVoltar">';
    echo '</form>';
    echo '</main>';
    echo '<footer>';
            echo '<div class="container-fluid">';
    ...
    echo '</html>';
      ...
      echo '<form action="" method="post">';
        ...
        echo '</form>';
        echo '<form action="" method="post">';
        echo '<input type="submit" value="Próxima Página" id="inputMesa" style="margin: 0px; margin-top: 1em; margin-right: 0.1em;" name="botao">';
        echo '</form>';
      echo '</main>';
      echo '<footer>';
              echo '<div class="container-fluid">';
